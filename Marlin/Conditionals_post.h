 ...
 */
  ...
  #define HEATER_BED_USES_DS18B20
...
#define HAS_ADC_TEST(P) (PIN_EXISTS(TEMP_##P) && TEMP_SENSOR_##P != 0 && DISABLED(HEATER_##P##_USES_MAX6675) && DISABLED(HEATER_##P##_USES_DS18B20))
...
#define HAS_TEMP_HOTEND (HAS_TEMP_ADC_0 || ENABLED(HEATER_0_USES_MAX6675) || ENABLED(HEATER_0_USES_DS18B20))
#define HAS_TEMP_BED (HAS_TEMP_ADC_BED || ENABLED(HEATER_BED_USES_DS18B20))
